# QuestWordHunter — German Voiceover: Dragonflight

The German a quest giver says out loud, for Dragonflight: quest ids
**64,001–74,000**.

**14,574 clips, 16.1 hours.** Both are counted from this pack's own duration table in
...
`sounds/` is committed, and `.gitignore` says why. It is 287 MB here, out of
...
```
python Tools/build_pack.py --only Dragonflight --out "…/Interface/AddOns"
```
